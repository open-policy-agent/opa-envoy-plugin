...
import fmt "fmt"
import math "math"
import envoy_api_v2_core "github.com/envoyproxy/data-plane-api/envoy/api/v2/core"
import envoy_type "github.com/envoyproxy/data-plane-api/envoy/type"
...
func encodeFixed64ExternalAuth(dAtA []byte, offset int, v uint64) int {
	dAtA[offset] = uint8(v)
...
func encodeFixed32ExternalAuth(dAtA []byte, offset int, v uint32) int {
	dAtA[offset] = uint8(v)
	dAtA[offset+1] = uint8(v >> 8)
	dAtA[offset+2] = uint8(v >> 16)
	dAtA[offset+3] = uint8(v >> 24)
