...
import fmt "fmt"
import math "math"
import envoy_api_v2_core1 "github.com/envoyproxy/data-plane-api/envoy/api/v2/core"
...
func encodeFixed64AttributeContext(dAtA []byte, offset int, v uint64) int {
	dAtA[offset] = uint8(v)
...
func encodeFixed32AttributeContext(dAtA []byte, offset int, v uint32) int {
	dAtA[offset] = uint8(v)
	dAtA[offset+1] = uint8(v >> 8)
	dAtA[offset+2] = uint8(v >> 16)
	dAtA[offset+3] = uint8(v >> 24)
