...
func (m *TransportSocket) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ConfigType != nil {
		nn7, err7 := m.ConfigType.MarshalTo(dAtA[i:])
		if err7 != nil {
			return 0, err7
		}
		i += nn7
...
func (m *TransportSocket_Config) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Config != nil {
		...
		n8, err8 := m.Config.MarshalTo(dAtA[i:])
		if err8 != nil {
			return 0, err8
		}
		i += n8
...
func (m *TransportSocket_TypedConfig) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TypedConfig != nil {
		...
		n9, err9 := m.TypedConfig.MarshalTo(dAtA[i:])
		if err9 != nil {
			return 0, err9
		}
		i += n9
...
func (m *SocketOption) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Value != nil {
		nn10, err10 := m.Value.MarshalTo(dAtA[i:])
		if err10 != nil {
			return 0, err10
		}
		i += nn10
...
func (m *RuntimeFractionalPercent) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.DefaultValue != nil {
		...
		n11, err11 := m.DefaultValue.MarshalTo(dAtA[i:])
		if err11 != nil {
			return 0, err11
		}
		i += n11
