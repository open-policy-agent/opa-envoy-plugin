...
With denied response,
array of headers can be passed to the downstream client.
...
The input to policy is show below:
```
{
  "attributes": {
    "request": {
...
The response generated by the policy for the above input looks like below:
```
{
  "allowed": false,
  "body": "Unauthorized Request",
